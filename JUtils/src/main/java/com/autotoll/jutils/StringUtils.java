...
public class StringUtils {
     ...
     * @return
     */
    public static String formatLinceNo(String linceNoChina, String linceNoHk ){
        if(isNotEmpty(linceNoHk)&&isNotEmpty(linceNoChina)){
            return linceNoHk+" / "+linceNoChina;
        }else if(isNotEmpty(linceNoHk)&&isEmpty(linceNoChina)){
            return linceNoHk;
        }else if(isNotEmpty(linceNoChina)&&isEmpty(linceNoHk)){
            return linceNoChina;
        }else {
            return "--";
        }
     ...
     * @return
     */
    public static String toFirstLetterUpperCase(String str, String methodName) {
        if(str == null || str.length() < 2){
            return str;
        }
        String firstLetter = str.substring(0, 1).toUpperCase();
        return methodName+firstLetter + str.substring(1, str.length());
    }
